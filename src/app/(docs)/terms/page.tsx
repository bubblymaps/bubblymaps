            ...
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                ...
                <div className="mb-4 p-4 border rounded-lg bg-green-100 dark:bg-green-900">
                    ...
                    <p className="text-green-900 dark:text-green-100">
                        These Terms and Conditions are effective as of November 14, 2025.
                    </p>
                </div>
                ...
                <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-muted-foreground leading-relaxed mb-4">
                            For questions, concerns, or notices regarding these Terms, please contact us at: <a href="mailto:legal@bubblymaps.org" className="text-primary underline">legal@bubblymaps.org</a>
                        </p>
                    </section>
